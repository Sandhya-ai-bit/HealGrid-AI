...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Agentic AI that transforms 10,000+ Indian medical facility records into trustworthy, explainable healthcare intelligence." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "HEALGRID AI — India's Healthcare Intelligence Grid" },
      { name: "twitter:description", content: "Agentic AI that transforms 10,000+ Indian medical facility records into trustworthy, explainable healthcare intelligence." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/03222fb9-46cc-4ff7-844a-2743a8553d30/id-preview-8151d7d8--1b8697cd-1cf5-4675-854b-c4bbf83f5594.lovable.app-1777190330299.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/03222fb9-46cc-4ff7-844a-2743a8553d30/id-preview-8151d7d8--1b8697cd-1cf5-4675-854b-c4bbf83f5594.lovable.app-1777190330299.png" },
